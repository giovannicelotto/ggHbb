...
def getProcessesDataFrame():
    ...
    nanoFolder =                "MC_samples2026Jan15"
    ...
    'QCD_MuEnriched_Pt-1000':           [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-1000*",                                                                               flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt1000ToInf"             ,    1.085],                     # 23    
    'QCD_MuEnriched_Pt-800To1000':      [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-800To1000*",                                                                          flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt800To1000"             ,    3.318],                     # 24    
    'QCD_MuEnriched_Pt-600To800':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-600To800*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt600To800"              ,    18.12	],                  # 25        
    'QCD_MuEnriched_Pt-470To600':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-470To600*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt470To600"              ,    58.9],                      # 26    
    'QCD_MuEnriched_Pt-300To470':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-300To470*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt300To470"              ,    622.6],                     # 27    
    'QCD_MuEnriched_Pt-170To300':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-170To300*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt170To300"              ,    7000.0],                    # 28        
    'QCD_MuEnriched_Pt-120To170':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-120To170*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt120To170"              ,    21280.0],                   # 29        
    'QCD_MuEnriched_Pt-80To120':        [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-80To120*",                                                                            flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt80To120"               ,    87740.0],                   # 30        
    'QCD_MuEnriched_Pt-50To80':         [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-50To80*",                                                                             flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt50To80"                ,    381700.0],                  # 31        
    ...
    'WminusH_HToBB_WToLNu'      :                   [nanoPathCommon + "/"+nanoFolder+"/WminusH_HToBB_WToQQ_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/WminusH_HToBB_WToLNu" ,                      0.527*0.58 * 0.1086*3],                # 36    
...
# Now create a dataframe for JEC
    ...
    processesData ={
    'Data1A':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH1/crab_data_Run2018A_part1",                         flatPathCommon + "/Data1A"    ,                     0.774,     1017],                  # 0              
    'Data2A':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH2/crab_data_Run2018A_part2",                         flatPathCommon + "/Data2A"    ,                     0.774,     1018],                     # 1              
    'Data3A':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH3/crab_data_Run2018A_part3",                         flatPathCommon + "/Data3A"    ,                     0.774,     1018],                     # 3              
    'Data4A':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH4/crab_data_Run2018A_part4",                         flatPathCommon + "/Data4A"    ,                     0.774,     1016],                     # 4              
    'Data5A':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH5/crab_data_Run2018A_part5",                         flatPathCommon + "/Data5A"    ,                     0.774,     1016],                     # 5              
    'Data6A':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH6/crab_data_Run2018A_part6",                         flatPathCommon + "/Data6A"    ,                     0.774,     1017],                     # ???             
    
    
    'Data1B':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH1/crab_data_Run2018B_part1",                         flatPathCommon + "/Data1B"    ,                     0.911,     987],                  # 8              987
    'Data2B':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH2/crab_data_Run2018B_part2",                         flatPathCommon + "/Data2B"    ,                     0.911,     1020],                     # 9              1020
    'Data3B':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH3/crab_data_Run2018B_part3",                         flatPathCommon + "/Data3B" ,                        0.911,     1020],                     # 10              1020
    'Data4B':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH4/crab_data_Run2018B_part4",                         flatPathCommon + "/Data4B"    ,                     0.911,     1020],                     # 11              1020
    'Data5B':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH5/crab_data_Run2018B_part5",                         flatPathCommon + "/Data5B"    ,                     0.911,     1018],                     # 12              1018
    'Data6B':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH6/crab_data_Run2018B_part6",                         flatPathCommon + "/Data6B"    ,                     0.377,     494],                     # 13               494
# Data C is checked!
    'Data1C':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH1/crab_data_Run2018C_part1",                         flatPathCommon + "/Data1C"    ,                     1.103,     1105],                  # 14              
    'Data2C':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH2/crab_data_Run2018C_part2",                         flatPathCommon + "/Data2C"    ,                     1.103,     1107],                     # 15
    'Data3C':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH3/crab_data_Run2018C_part3",                         flatPathCommon + "/Data3C" ,                        1.103,     1102],                     # 16
    'Data4C':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH4/crab_data_Run2018C_part4",                         flatPathCommon + "/Data4C"    ,                     1.103,     1108],                     # 17       V
    'Data5C':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH5/crab_data_Run2018C_part5",                         flatPathCommon + "/Data5C"    ,                     1.103,     1105],                     # 18       V
# Daata D checked
    'Data1D':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH1/crab_data_Run2018D_part1",                         flatPathCommon + "/Data1D" ,                        5.302,     5524],                     # 2           5524
    'Data2D':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH2/crab_data_Run2018D_part2",                         flatPathCommon + "/Data2D"    ,                     5.302,     5532],                     # 7              5532
    'Data3D':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH3/crab_data_Run2018D_part3",                         flatPathCommon + "/Data3D"    ,                     5.302,     5437],                     # 7           5437   V
    'Data4D':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH4/crab_data_Run2018D_part4",                         flatPathCommon + "/Data4D"    ,                     5.302,     5521],                     # 7         5521     
    'Data5D':                          [nanoPathCommon + "/Data_90GeV2026Jan15/ParkingBPH5/crab_data_Run2018D_part5",                         flatPathCommon + "/Data5D"    ,                     5.302,     5517],                     # 7       5517          
