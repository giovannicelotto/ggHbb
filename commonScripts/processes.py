...
def getProcessesDataFrame():
    ...
    nanoFolder      = "AllMC2026Mar06" # Disregard the dijet value here
    nanoFolderQCD      = "QCD_genPart2026Apr03" # Disregard the dijet value here
    nanoFolderData  = "DataMu9IP6_50GeV2026Apr09"
    nanoFolderData_lowPt = "Data_pt0To602026Mar19"
    processesMC = {
    'GluGluHToBB':                      [nanoPathCommon + "/signalAlternative2026Apr09/GluGluHToBB_M-125_TuneCP5_13TeV-powheg-pythia8",                            flatPathCommon+"/MC" + "/GluGluHToBB"    ,                48.61*0.58],                # 0     
    'EWKZJets':                         [nanoPathCommon + "/"+nanoFolder+"/EWKZ2Jets*",                                                                          flatPathCommon+"/MC" + "/EWKZJets",                       9.8],                       # 1     
    'WW':                               [nanoPathCommon + "/"+nanoFolder+"/WW_TuneCP5_13TeV-pythia8",                                                            flatPathCommon+"/MC" + "/diboson/WW",                     75.8],                      # 2     
    ...
    'ST_s-channel-hadronic':            [nanoPathCommon + "/"+nanoFolder+"/ST_s-channel_4f_hadronicDecays_TuneCP5_13TeV-amcatnlo-pythia8",                       flatPathCommon+"/MC" + "/singleTop/s-channel_hadronic",          11.24],                     # 5     
    'ST_s-channel-leptononic':          [nanoPathCommon + "/"+nanoFolder+"/ST_s-channel_4f_leptonDecays_TuneCP5_13TeV-amcatnlo-pythia8",                         flatPathCommon+"/MC" + "/singleTop/s-channel_leptonic",          3.74],                      # 6 
    'ST_t-channel-antitop':             [nanoPathCommon + "/"+nanoFolder+"/ST_t-channel_antitop_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8",        flatPathCommon+"/MC" + "/singleTop/t-channel_antitop" ,          69.09],                     # 7     
    'ST_t-channel-top':                 [nanoPathCommon + "/"+nanoFolder+"/ST_t-channel_top_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8",            flatPathCommon+"/MC" + "/singleTop/t-channel_top"     ,          115.3],                     # 8     
    'ST_tW-antitop':                    [nanoPathCommon + "/"+nanoFolder+"/ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8",                       flatPathCommon+"/MC" + "/singleTop/tW-channel_antitop",          34.97],                     # 9     
    'ST_tW-top':                        [nanoPathCommon + "/"+nanoFolder+"/ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8",                           flatPathCommon+"/MC" + "/singleTop/tW-channel_top"    ,          34.91	],                  # 10        
    ...
    'TTTo2L2Nu':                        [nanoPathCommon + "/ttbar2l2nu_genPart2026Apr16/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8",                                              flatPathCommon+"/MC" + "/ttbar/ttbar2L2Nu"            ,   833.9*(0.1086*3)**2],       # 11        
    'TTToHadronic':                     [nanoPathCommon + "/ttbar_genPart2026Apr15/TTToHadronic_TuneCP5_13TeV-powheg-pythia8",                                           flatPathCommon+"/MC" + "/ttbar/ttbarHadronic"         ,   833.9*(0.6741)**2],         # 12        
    'TTToSemiLeptonic':                 [nanoPathCommon + "/ttbar_genPart2026Apr15/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8",                                       flatPathCommon+"/MC" + "/ttbar/ttbarSemiLeptonic"     ,   2*833.9*0.6741*0.1086*3],   # 13        
    'WJetsToLNu':                       [nanoPathCommon + "/"+nanoFolder+"/WJetsToLNu*",                                                                         flatPathCommon+"/MC" + "/WJets/WJetsToLNu"            ,   62070.0],                   # 14            
    'WJetsToQQ_200to400'      :         [nanoPathCommon + "/"+nanoFolder+"/WJetsToQQ_HT-200to400*",                                                              flatPathCommon+"/MC" + "/WJets/WJetsToQQ_HT-200to400" ,   2549.0],                    # 15    
    'WJetsToQQ_400to600'      :         [nanoPathCommon + "/"+nanoFolder+"/WJetsToQQ_HT-400to600*",                                                              flatPathCommon+"/MC" + "/WJets/WJetsToQQ_HT-400to600" ,   276.5],                     # 16
    'WJetsToQQ_600to800'      :         [nanoPathCommon + "/"+nanoFolder+"/WJetsToQQ_HT-600to800*",                                                              flatPathCommon+"/MC" + "/WJets/WJetsToQQ_HT-600to800" ,   59.25],                     # 17
    'WJetsToQQ_800toInf'      :         [nanoPathCommon + "/"+nanoFolder+"/WJetsToQQ_HT-800toInf*",                                                              flatPathCommon+"/MC" + "/WJets/WJetsToQQ_HT-800toInf" ,   28.75],                     # 18
    ...
    'QCD_MuEnriched_Pt-1000':           [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-1000*",                                                                               flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt1000ToInf"             ,    1.085],                     # 23    
    'QCD_MuEnriched_Pt-800To1000':      [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-800To1000*",                                                                          flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt800To1000"             ,    3.318],                     # 24    
    'QCD_MuEnriched_Pt-600To800':       [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-600To800*",                                                                           flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt600To800"              ,    18.12	],                  # 25        
    'QCD_MuEnriched_Pt-470To600':       [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-470To600*",                                                                           flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt470To600"              ,    58.9],                      # 26    
    'QCD_MuEnriched_Pt-300To470':       [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-300To470*",                                                                           flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt300To470"              ,    622.6],                     # 27    
    'QCD_MuEnriched_Pt-170To300':       [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-170To300*",                                                                           flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt170To300"              ,    7000.0],                    # 28        
    'QCD_MuEnriched_Pt-120To170':       [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-120To170*",                                                                           flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt120To170"              ,    21280.0],                   # 29        
    'QCD_MuEnriched_Pt-80To120':        [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-80To120*",                                                                            flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt80To120"               ,    87740.0],                   # 30        
    'QCD_MuEnriched_Pt-50To80':         [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-50To80*",                                                                             flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt50To80"                ,    381700.0],                  # 31        
    'QCD_MuEnriched_Pt-30To50':         [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-30To50*",                                                                             flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt30To50"                ,    1367000.0],                 # 32        
    'QCD_MuEnriched_Pt-20To30':         [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-20To30*",                                                                             flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt20To30"                ,    2527000.0],                 # 33        
    'QCD_MuEnriched_Pt-15To20':         [nanoPathCommon + "/"+nanoFolderQCD+"/QCD_Pt-15To20*",                                                                             flatPathCommon+"/MC/QCDMuEnriched/QCD_Pt15To20"                ,    2800000.0	],              # 34            
    ...
    'GluGluH_M500_ToBB':                [nanoPathCommon +"/"+nanoFolder+"/GluGluSpin0ToBBbar_W_1p0_M_500_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC/GluGluH_M500_ToBB",              48.61*0.58],                # 42          # 37
    'GluGluH_M700_ToBB':                [nanoPathCommon +"/"+nanoFolder+"/GluGluSpin0ToBBbar_W_1p0_M_700_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC/GluGluH_M700_ToBB",              48.61*0.58],                # 42          # 37
    'GluGluH_M1000_ToBB':                [nanoPathCommon +"/"+nanoFolder+"/GluGluSpin0ToBBbar_W_1p0_M_1000_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC/GluGluH_M1000_ToBB",              48.61*0.58],                # 42          # 37
    'GluGluHToBB_amcatnlo'          :       [nanoPathCommon + "/signalAlternative2026Apr09/GluGluHToBB_M-125_TuneCP5_13TeV-amcatnloFXFX-pythia8",                        flatPathCommon+"/MC" + "/GluGluHToBB_amcatnlo",               48.61*0.58],                # 37
    ...
    'DYToLL':                               [nanoPathCommon+"/"+nanoFolder+"/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/crab_DYJetsToLL/**/0000", flatPathCommon+"/MC/DYToLL", 2025.74*3],
    'ZH_HToBB_ZToLL'      :                   [nanoPathCommon + "/"+nanoFolder+"/ZH_HToBB_ZToLL_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/ZH_HToBB_ZToLL" ,                      0.880*0.58 * 0.033658*3],                # 36    
    'ZH_HToBB_ZToNuNu'      :                   [nanoPathCommon + "/"+nanoFolder+"/ZH_HToBB_ZToNuNu_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/ZH_HToBB_ZToNuNu" ,                      0.88*0.58*0.20],                # 36    
    'ZH_HToBB_ZToQQ'      :                   [nanoPathCommon + "/"+nanoFolder+"/ZH_HToBB_ZToQQ_M125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/ZH_HToBB_ZToQQ" ,                      0.88*0.58 * 0.69911],                # 36    
    'WplusH_HToBB_WToQQ'      :                   [nanoPathCommon + "/"+nanoFolder+"/WplusH_HToBB_WToQQ_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/WplusH_HToBB_WToQQ" ,                      0.831*0.58 * 0.6741],                # 36    
    ...
    "GluGluHToBBMINLO_private_training"      :       [nanoPathCommon + "/"+nanoFolder,                                                                           flatPathCommon+"/MC/MINLOGluGluHToBB/training", 48.61*0.58],
...
# Now create a dataframe for JEC
    ...
    processesData ={
    'Data1A':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH1/crab_data_Run2018A_part1",                         flatPathCommon + "/Data1A"    ,                     0.774,     1105],                  # 0              
    'Data2A':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH2/crab_data_Run2018A_part2",                         flatPathCommon + "/Data2A"    ,                     0.774,     1015],                     # 1              
    'Data3A':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH3/crab_data_Run2018A_part3",                         flatPathCommon + "/Data3A"    ,                     0.774,     1015],                     # 3              
    'Data4A':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH4/crab_data_Run2018A_part4",                         flatPathCommon + "/Data4A"    ,                     0.774,     1015],                     # 4              
    'Data5A':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH5/crab_data_Run2018A_part5",                         flatPathCommon + "/Data5A"    ,                     0.774,     1015],                     # 5              
    'Data6A':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH6/crab_data_Run2018A_part6",                         flatPathCommon + "/Data6A"    ,                     0.774,     1015],                     # ???             
    
    
    'Data1B':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH1/crab_data_Run2018B_part1",                         flatPathCommon + "/Data1B"    ,                     0.911,     1018],                  # 8              987
    'Data2B':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH2/crab_data_Run2018B_part2",                         flatPathCommon + "/Data2B"    ,                     0.911,     1017],                     # 9              1020
    'Data3B':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH3/crab_data_Run2018B_part3",                         flatPathCommon + "/Data3B" ,                        0.911,     1017],                     # 10              1020
    'Data4B':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH4/crab_data_Run2018B_part4",                         flatPathCommon + "/Data4B"    ,                     0.911,     1018],                     # 11              1020
    'Data5B':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH5/crab_data_Run2018B_part5",                         flatPathCommon + "/Data5B"    ,                     0.911,     1018],                     # 12              1018
    'Data6B':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH6/crab_data_Run2018B_part6",                         flatPathCommon + "/Data6B"    ,                     0.377,     492],                     # 13               494
# Data C is checked!
    'Data1C':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH1/crab_data_Run2018C_part1",                         flatPathCommon + "/Data1C"    ,                     1.103,     1102],                  # 14              
    'Data2C':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH2/crab_data_Run2018C_part2",                         flatPathCommon + "/Data2C"    ,                     1.103,     1102],                     # 15
    'Data3C':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH3/crab_data_Run2018C_part3",                         flatPathCommon + "/Data3C" ,                        1.103,     1101],                     # 16
    'Data4C':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH4/crab_data_Run2018C_part4",                         flatPathCommon + "/Data4C"    ,                     1.103,     1102],                     # 17       V
    'Data5C':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH5/crab_data_Run2018C_part5",                         flatPathCommon + "/Data5C"    ,                     1.103,     1102],                     # 18       V
# Daata D checked
    'Data1D':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH1/crab_data_Run2018D_part1",                         flatPathCommon + "/Data1D" ,                        5.302,     5523],                     # 2           5524
    'Data2D':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH2/crab_data_Run2018D_part2",                         flatPathCommon + "/Data2D"    ,                     5.302,     5525],                     # 7              5532
    'Data3D':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH3/crab_data_Run2018D_part3",                         flatPathCommon + "/Data3D"    ,                     5.302,     5521],                     # 7           5437   V
    'Data4D':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH4/crab_data_Run2018D_part4",                         flatPathCommon + "/Data4D"    ,                     5.302,     5516],                     # 7         5521     
    'Data5D':                          [nanoPathCommon + "/"+nanoFolderData+"/ParkingBPH5/crab_data_Run2018D_part5",                         flatPathCommon + "/Data5D"    ,                     5.302,     5510],                     # 7       5517          
