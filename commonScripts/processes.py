...
def getProcessesDataFrame():
    ...
    'WW':                               [nanoPathCommon + "/"+nanoFolder+"/WW_TuneCP5_13TeV-pythia8",                                                            flatPathCommon+"/others" + "/diboson/WW",                     75.8],                      # 2     
    ...
    'ST_s-channel-hadronic':            [nanoPathCommon + "/"+nanoFolder+"/ST_s-channel_4f_hadronicDecays_TuneCP5_13TeV-amcatnlo-pythia8",                       flatPathCommon+"/others" + "/singleTop/s-channel_hadronic",          11.24],                     # 5     
    'ST_s-channel-leptononic':          [nanoPathCommon + "/"+nanoFolder+"/ST_s-channel_4f_leptonDecays_TuneCP5_13TeV-amcatnlo-pythia8",                         flatPathCommon+"/others" + "/singleTop/s-channel_leptonic",          3.74],                      # 6 
    'ST_t-channel-antitop':             [nanoPathCommon + "/"+nanoFolder+"/ST_t-channel_antitop_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8",        flatPathCommon+"/others" + "/singleTop/t-channel_antitop" ,          69.09],                     # 7     
    'ST_t-channel-top':                 [nanoPathCommon + "/"+nanoFolder+"/ST_t-channel_top_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8",            flatPathCommon+"/others" + "/singleTop/t-channel_top"     ,          115.3],                     # 8     
    'ST_tW-antitop':                    [nanoPathCommon + "/"+nanoFolder+"/ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8",                       flatPathCommon+"/others" + "/singleTop/tW-channel_antitop",          34.97],                     # 9     
    'ST_tW-top':                        [nanoPathCommon + "/"+nanoFolder+"/ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8",                           flatPathCommon+"/others" + "/singleTop/tW-channel_top"    ,          34.91	],                  # 10        
    ...
    'TTTo2L2Nu':                        [nanoPathCommon + "/"+nanoFolder+"/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8",                                              flatPathCommon+"/others" + "/ttbar/ttbar2L2Nu"            ,   833.9*(0.1086*3)**2],       # 11        
    'TTToHadronic':                     [nanoPathCommon + "/"+nanoFolder+"/TTToHadronic_TuneCP5_13TeV-powheg-pythia8",                                           flatPathCommon+"/others" + "/ttbar/ttbarHadronic"         ,   833.9*(0.6741)**2],         # 12        
    'TTToSemiLeptonic':                 [nanoPathCommon + "/"+nanoFolder+"/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8",                                       flatPathCommon+"/others" + "/ttbar/ttbarSemiLeptonic"     ,   2*833.9*0.6741*0.1086*3],   # 13        
    'WJetsToLNu':                       [nanoPathCommon + "/"+nanoFolder+"/WJetsToLNu*",                                                                         flatPathCommon+"/others" + "/WJets/WJetsToLNu"            ,   62070.0],                   # 14            
    'WJetsToQQ_200to400'      :         [nanoPathCommon + "/"+nanoFolder+"/WJetsToQQ_HT-200to400*",                                                              flatPathCommon+"/others" + "/WJets/WJetsToQQ_HT-200to400" ,   2549.0],                    # 15    
    'WJetsToQQ_400to600'      :         [nanoPathCommon + "/"+nanoFolder+"/WJetsToQQ_HT-400to600*",                                                              flatPathCommon+"/others" + "/WJets/WJetsToQQ_HT-400to600" ,   276.5],                     # 16
    'WJetsToQQ_600to800'      :         [nanoPathCommon + "/"+nanoFolder+"/WJetsToQQ_HT-600to800*",                                                              flatPathCommon+"/others" + "/WJets/WJetsToQQ_HT-600to800" ,   59.25],                     # 17
    'WJetsToQQ_800toInf'      :         [nanoPathCommon + "/"+nanoFolder+"/WJetsToQQ_HT-800toInf*",                                                              flatPathCommon+"/others" + "/WJets/WJetsToQQ_HT-800toInf" ,   28.75],                     # 18
    ...
    'QCD_MuEnriched_Pt-1000':           [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-1000*",                                                                               flatPathCommon+"/others" + "/QCD_Pt1000ToInf"             ,    1.085],                     # 23    
    'QCD_MuEnriched_Pt-800To1000':      [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-800To1000*",                                                                          flatPathCommon+"/others" + "/QCD_Pt800To1000"             ,    3.318],                     # 24    
    'QCD_MuEnriched_Pt-600To800':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-600To800*",                                                                           flatPathCommon+"/others" + "/QCD_Pt600To800"              ,    18.12	],                  # 25        
    'QCD_MuEnriched_Pt-470To600':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-470To600*",                                                                           flatPathCommon+"/others" + "/QCD_Pt470To600"              ,    58.9],                      # 26    
    'QCD_MuEnriched_Pt-300To470':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-300To470*",                                                                           flatPathCommon+"/others" + "/QCD_Pt300To470"              ,    622.6],                     # 27    
    'QCD_MuEnriched_Pt-170To300':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-170To300*",                                                                           flatPathCommon+"/others" + "/QCD_Pt170To300"              ,    7000.0],                    # 28        
    'QCD_MuEnriched_Pt-120To170':       [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-120To170*",                                                                           flatPathCommon+"/others" + "/QCD_Pt120To170"              ,    21280.0],                   # 29        
    'QCD_MuEnriched_Pt-80To120':        [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-80To120*",                                                                            flatPathCommon+"/others" + "/QCD_Pt80To120"               ,    87740.0],                   # 30        
    'QCD_MuEnriched_Pt-50To80':         [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-50To80*",                                                                             flatPathCommon+"/others" + "/QCD_Pt50To80"                ,    381700.0],                  # 31        
    'QCD_MuEnriched_Pt-30To50':         [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-30To50*",                                                                             flatPathCommon+"/others" + "/QCD_Pt30To50"                ,    1367000.0],                 # 32        
    'QCD_MuEnriched_Pt-20To30':         [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-20To30*",                                                                             flatPathCommon+"/others" + "/QCD_Pt20To30"                ,    2527000.0],                 # 33        
    'QCD_MuEnriched_Pt-15To20':         [nanoPathCommon + "/"+nanoFolder+"/QCD_Pt-15To20*",                                                                             flatPathCommon+"/others" + "/QCD_Pt15To20"                ,    2800000.0	],              # 34            
    ...
    'GluGluHToBBMINLO'          :       [nanoPathCommon + "/"+nanoFolder+"/GluGluHToBB_M-125_TuneCP5_MINLO_NNLOPS_13TeV-powheg-pythia*/",                        flatPathCommon+"/MC" + "/MINLOGluGluHToBB",               48.61*0.58],                # 37
    ...
    'GluGluHToBBMINLO_smearedDown'          :       [nanoPathCommon + "/"+nanoFolder_smearedDown+"/GluGluHToBB_M-125_TuneCP5_MINLO_NNLOPS_13TeV-powheg-pythia*/",                        flatPathCommon+"/JER" + "/MINLOGluGluHToBB_sD" ,               48.61*0.58],                # 37
    ...
    'GluGluHToBBMINLO_smearedUp'          :       [nanoPathCommon + "/"+nanoFolder_smearedUp+"/GluGluHToBB_M-125_TuneCP5_MINLO_NNLOPS_13TeV-powheg-pythia*/",                        flatPathCommon+"/JER" + "/MINLOGluGluHToBB_sU" ,               48.61*0.58],                # 37
    ...
    'GluGluHToBBMINLO'          :       [nanoPathCommon + "/"+nanoFolder+"/GluGluHToBB_M-125_TuneCP5_MINLO_NNLOPS_13TeV-powheg-pythia*/",                        flatPathCommon+"/JEC" + "/MINLOGluGluHToBB",               48.61*0.58],                # 37
