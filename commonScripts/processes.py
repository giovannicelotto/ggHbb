...
def getProcessesDataFrame():
    ...
    nanoFolder =                "MCSamples2025Aug15"
    nanoFolder_ttbar =          "ttbar_EleMET2025Aug11"
    nanoFolder_smearedDown =    "MC_fiducial_JESsmearedDown2025Apr08"
    nanoFolder_smearedUp =      "MC_fiducial_JESsmearedUp2025Apr08"
    processesMC = {
    'GluGluHToBB':                      [nanoPathCommon + "/ggHbb_powheg2025Nov27/GluGluHToBB_M-125_TuneCP5_13TeV-powheg-pythia8/*/*/*",                            flatPathCommon+"/MC" + "/GluGluHToBB/others"    ,                48.61*0.58],                # 0     
    ...
    'ST_s-channel-hadronic':            [nanoPathCommon + "/"+nanoFolder_ttbar+"/ST_s-channel_4f_hadronicDecays_TuneCP5_13TeV-amcatnlo-pythia8",                       flatPathCommon+"/nonResonant" + "/singleTop/s-channel_hadronic",          11.24],                     # 5     
    'ST_s-channel-leptononic':          [nanoPathCommon + "/"+nanoFolder_ttbar+"/ST_s-channel_4f_leptonDecays_TuneCP5_13TeV-amcatnlo-pythia8",                         flatPathCommon+"/nonResonant" + "/singleTop/s-channel_leptonic",          3.74],                      # 6 
    'ST_t-channel-antitop':             [nanoPathCommon + "/"+nanoFolder_ttbar+"/ST_t-channel_antitop_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8",        flatPathCommon+"/nonResonant" + "/singleTop/t-channel_antitop" ,          69.09],                     # 7     
    'ST_t-channel-top':                 [nanoPathCommon + "/"+nanoFolder_ttbar+"/ST_t-channel_top_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8",            flatPathCommon+"/nonResonant" + "/singleTop/t-channel_top"     ,          115.3],                     # 8     
    'ST_tW-antitop':                    [nanoPathCommon + "/"+nanoFolder_ttbar+"/ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8",                       flatPathCommon+"/nonResonant" + "/singleTop/tW-channel_antitop",          34.97],                     # 9     
    'ST_tW-top':                        [nanoPathCommon + "/"+nanoFolder_ttbar+"/ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8",                           flatPathCommon+"/nonResonant" + "/singleTop/tW-channel_top"    ,          34.91	],                  # 10        
    ...
    'TTTo2L2Nu':                        [nanoPathCommon + "/"+nanoFolder_ttbar+"/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8",                                              flatPathCommon+"/nonResonant" + "/ttbar/ttbar2L2Nu"            ,   833.9*(0.1086*3)**2],       # 11        
    'TTToHadronic':                     [nanoPathCommon + "/"+nanoFolder_ttbar+"/TTToHadronic_TuneCP5_13TeV-powheg-pythia8",                                           flatPathCommon+"/nonResonant" + "/ttbar/ttbarHadronic"         ,   833.9*(0.6741)**2],         # 12        
    'TTToSemiLeptonic':                 [nanoPathCommon + "/"+nanoFolder_ttbar+"/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8",                                       flatPathCommon+"/nonResonant" + "/ttbar/ttbarSemiLeptonic"     ,   2*833.9*0.6741*0.1086*3],   # 13        
    ...
    'QCD_MuEnriched_Pt-1000':           [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-1000*",                                                                               flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt1000ToInf"             ,    1.085],                     # 23    
    'QCD_MuEnriched_Pt-800To1000':      [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-800To1000*",                                                                          flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt800To1000"             ,    3.318],                     # 24    
    'QCD_MuEnriched_Pt-600To800':       [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-600To800*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt600To800"              ,    18.12	],                  # 25        
    'QCD_MuEnriched_Pt-470To600':       [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-470To600*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt470To600"              ,    58.9],                      # 26    
    'QCD_MuEnriched_Pt-300To470':       [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-300To470*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt300To470"              ,    622.6],                     # 27    
    'QCD_MuEnriched_Pt-170To300':       [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-170To300*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt170To300"              ,    7000.0],                    # 28        
    'QCD_MuEnriched_Pt-120To170':       [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-120To170*",                                                                           flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt120To170"              ,    21280.0],                   # 29        
    'QCD_MuEnriched_Pt-80To120':        [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-80To120*",                                                                            flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt80To120"               ,    87740.0],                   # 30        
    'QCD_MuEnriched_Pt-50To80':         [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-50To80*",                                                                             flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt50To80"                ,    381700.0],                  # 31        
    'QCD_MuEnriched_Pt-30To50':         [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-30To50*",                                                                             flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt30To50"                ,    1367000.0],                 # 32        
    'QCD_MuEnriched_Pt-20To30':         [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-20To30*",                                                                             flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt20To30"                ,    2527000.0],                 # 33        
    'QCD_MuEnriched_Pt-15To20':         [nanoPathCommon + "/"+"QCDMuEnriched2025Aug13/"+"/QCD_Pt-15To20*",                                                                             flatPathCommon+"/nonResonant/QCDMuEnriched/QCD_Pt15To20"                ,    2800000.0	],              # 34            
    ...
    'GluGluH_M50_ToBB':                 [nanoPathCommon +"/GluGluSpin0_allMasses2025Aug12/GluGluSpin0ToBBbar_W_1p0_M_50_MuEnriched_TuneCP5_13TeV_pythia8",                           flatPathCommon+"/MC" + "/GluGluH_M50_ToBB",               48.61*0.58],                # 38
    'GluGluH_M70_ToBB':                 [nanoPathCommon +"/GluGluSpin0_allMasses2025Aug12/GluGluSpin0ToBBbar_W_1p0_M_70_MuEnriched_TuneCP5_13TeV_pythia8",                           flatPathCommon+"/MC" + "/GluGluH_M70_ToBB",               48.61*0.58],                # 39
    'GluGluH_M100_ToBB':                [nanoPathCommon +"/GluGluSpin0_allMasses2025Aug12/GluGluSpin0ToBBbar_W_1p0_M_100_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC" + "/GluGluH_M100_ToBB",              48.61*0.58],                # 40
    'GluGluH_M200_ToBB':                [nanoPathCommon +"/GluGluSpin0_allMasses2025Aug12/GluGluSpin0ToBBbar_W_1p0_M_200_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC" + "/GluGluH_M200_ToBB",              48.61*0.58],                # 41
    'GluGluH_M300_ToBB':                [nanoPathCommon +"/GluGluSpin0_allMasses2025Aug12/GluGluSpin0ToBBbar_W_1p0_M_300_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC" + "/GluGluH_M300_ToBB",              48.61*0.58],                # 42
    'GluGluH_M500_ToBB':                [nanoPathCommon +"/GluGluSpin0_allMasses2025Aug12/GluGluSpin0ToBBbar_W_1p0_M_500_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC/GluGluH_M500_ToBB",              48.61*0.58],                # 42          # 37
    'GluGluH_M700_ToBB':                [nanoPathCommon +"/GluGluSpin0_allMasses2025Aug12/GluGluSpin0ToBBbar_W_1p0_M_700_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC/GluGluH_M700_ToBB",              48.61*0.58],                # 42          # 37
    'GluGluH_M1000_ToBB':                [nanoPathCommon +"/GluGluSpin0_allMasses2025Aug12/GluGluSpin0ToBBbar_W_1p0_M_1000_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC/GluGluH_M1000_ToBB",              48.61*0.58],                # 42          # 37
    ...
    "GluGluHToBBMINLO_private"      :       [nanoPathCommon + "/GluGluHToBB_MINLO_PrivateProduction/M125",                                                                           flatPathCommon+"/MC//MINLOGluGluHToBB_private", 48.61*0.58],
    ...
    'DYToLL':                               [nanoPathCommon+"/MCSamples2025Aug15/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/crab_DYJetsToLL/250815_135202/0000", flatPathCommon+"/MC/DYToLL", 2025.74*3],
    'ZH_HToBB_ZToLL'      :                   [nanoPathCommon + "/VH_HToBB2025Oct04/ZH_HToBB_ZToLL_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/ZH_HToBB_ZToLL" ,                      0.880*0.58 * 0.033658*3],                # 36    
    'ZH_HToBB_ZToNuNu'      :                   [nanoPathCommon + "/VH_HToBB2025Oct04/ZH_HToBB_ZToNuNu_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/ZH_HToBB_ZToNuNu" ,                      0.88*0.58*0.20],                # 36    
    'ZH_HToBB_ZToQQ'      :                   [nanoPathCommon + "/VH_HToBB2025Oct04/ZH_HToBB_ZToQQ_M125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/ZH_HToBB_ZToQQ" ,                      0.88*0.58 * 0.69911],                # 36    
    'WplusH_HToBB_WToQQ'      :                   [nanoPathCommon + "/VH_HToBB2025Oct04/WplusH_HToBB_WToQQ_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/WplusH_HToBB_WToQQ" ,                      0.831*0.58 * 0.6741],                # 36    
    'WplusH_HToBB_WToLNu'      :                   [nanoPathCommon + "/VH_HToBB2025Oct04/WplusH_HToBB_WToLNu_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/WplusH_HToBB_WToLNu" ,                      0.831*0.58 * 0.1086*3],                # 36    
    'WminusH_HToBB_WToQQ'      :                   [nanoPathCommon + "/Wminus_HToBB2025Oct05/WminusH_HToBB_WToLNu_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/WminusH_HToBB_WToQQ" ,                      0.527*0.58 * 0.6741],                # 36    
    'WminusH_HToBB_WToLNu'      :                   [nanoPathCommon + "/Wminus_HToBB2025Oct05/WminusH_HToBB_WToQQ_M-125_TuneCP5_13TeV-powheg-pythia8*/",                                                                          flatPathCommon+"/MC" + "/WminusH_HToBB_WToLNu" ,                      0.527*0.58 * 0.1086*3],                # 36    
    ...
    #'GluGluHToBB_amcatnlo'          :       [nanoPathCommon + "/"+"/GluGluHToBB_amcatnlo2025May22/GluGluHToBB_M-125_TuneCP5_13TeV-amcatnloFXFX-pythia8",                        flatPathCommon+"/MC" + "/GluGluHToBB_amcatnlo",               48.61*0.58],      
    #'GluGluH_M50_ToBB_private':                 [nanoPathCommon + "/GluGluSpin0_ext12025Jun30/GluGluSpin0ToBBbar_W_1p0_M_50_MuEnriched_TuneCP5_13TeV_pythia8",                           flatPathCommon+"/MC/GluGluH_M50_ToBB_private",               48.61*0.58],                # 38
    #'GluGluH_M70_ToBB_private':                 [nanoPathCommon + "/GluGluSpin0_ext12025Jun30/GluGluSpin0ToBBbar_W_1p0_M_70_MuEnriched_TuneCP5_13TeV_pythia8",                           flatPathCommon+"/MC/GluGluH_M70_ToBB_private",               48.61*0.58],                # 39
    #'GluGluH_M100_ToBB_private':                [nanoPathCommon + "/GluGluSpin0_ext12025Jun30/GluGluSpin0ToBBbar_W_1p0_M_100_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC/GluGluH_M100_ToBB_private",              48.61*0.58],                # 40
    #'GluGluH_M125_ToBB_private':                [nanoPathCommon + "/GluGluSpin0_private/M125",                          flatPathCommon+"/MC/GluGluH_M125_ToBB_private",              48.61*0.58],                # 40
    #'GluGluH_M200_ToBB_private':                [nanoPathCommon + "/GluGluSpin0_ext12025Jun30/GluGluSpin0ToBBbar_W_1p0_M_200_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC/GluGluH_M200_ToBB_private",              48.61*0.58],                # 41
    #'GluGluH_M300_ToBB_private':                [nanoPathCommon + "/GluGluSpin0_ext12025Jun30/GluGluSpin0ToBBbar_W_1p0_M_300_MuEnriched_TuneCP5_13TeV_pythia8",                          flatPathCommon+"/MC/GluGluH_M300_ToBB_private",              48.61*0.58],                # 42          # 37
...
# Now create a dataframe for JEC
    ...
    processesData ={
    'Data1A':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH1/crab_data_Run2018A_part1",                         flatPathCommon + "/Data1A"    ,                     0.774,     1017],                  # 0              
    'Data2A':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH2/crab_data_Run2018A_part2",                         flatPathCommon + "/Data2A"    ,                     0.774,     1018],                     # 1              
    'Data3A':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH3/crab_data_Run2018A_part3",                         flatPathCommon + "/Data3A"    ,                     0.774,     1018],                     # 3              
    'Data4A':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH4/crab_data_Run2018A_part4",                         flatPathCommon + "/Data4A"    ,                     0.774,     1016],                     # 4              
    'Data5A':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH5/crab_data_Run2018A_part5",                         flatPathCommon + "/Data5A"    ,                     0.774,     1016],                     # 5              
    'Data6A':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH6/crab_data_Run2018A_part6",                         flatPathCommon + "/Data6A"    ,                     0.774,     1017],                     # ???             
    
    
    'Data1B':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH1/crab_data_Run2018B_part1",                         flatPathCommon + "/Data1B"    ,                     0.911,     987],                  # 8              987
    'Data2B':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH2/crab_data_Run2018B_part2",                         flatPathCommon + "/Data2B"    ,                     0.911,     1020],                     # 9              1020
    'Data3B':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH3/crab_data_Run2018B_part3",                         flatPathCommon + "/Data3B" ,                        0.911,     1020],                     # 10              1020
    'Data4B':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH4/crab_data_Run2018B_part4",                         flatPathCommon + "/Data4B"    ,                     0.911,     1020],                     # 11              1020
    'Data5B':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH5/crab_data_Run2018B_part5",                         flatPathCommon + "/Data5B"    ,                     0.911,     1018],                     # 12              1018
    'Data6B':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH6/crab_data_Run2018B_part6",                         flatPathCommon + "/Data6B"    ,                     0.377,     494],                     # 13               494
# Data C is checked!
    'Data1C':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH1/crab_data_Run2018C_part1",                         flatPathCommon + "/Data1C"    ,                     1.103,     1105],                  # 14              
    'Data2C':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH2/crab_data_Run2018C_part2",                         flatPathCommon + "/Data2C"    ,                     1.103,     1107],                     # 15
    'Data3C':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH3/crab_data_Run2018C_part3",                         flatPathCommon + "/Data3C" ,                        1.103,     1102],                     # 16
    'Data4C':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH4/crab_data_Run2018C_part4",                         flatPathCommon + "/Data4C"    ,                     1.103,     1108],                     # 17       V
    'Data5C':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH5/crab_data_Run2018C_part5",                         flatPathCommon + "/Data5C"    ,                     1.103,     1105],                     # 18       V
# Daata D checked
    'Data1D':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH1/crab_data_Run2018D_part1",                         flatPathCommon + "/Data1D" ,                        5.302,     5524],                     # 2           5524
    'Data2D':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH2/crab_data_Run2018D_part2",                         flatPathCommon + "/Data2D"    ,                     5.302,     5532],                     # 7              5532
    'Data3D':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH3/crab_data_Run2018D_part3",                         flatPathCommon + "/Data3D"    ,                     5.302,     5437],                     # 7           5437   V
    'Data4D':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH4/crab_data_Run2018D_part4",                         flatPathCommon + "/Data4D"    ,                     5.302,     5521],                     # 7         5521     
    'Data5D':                          [nanoPathCommon + "/DataFiltered_nob2025Oct26/ParkingBPH5/crab_data_Run2018D_part5",                         flatPathCommon + "/Data5D"    ,                     5.302,     5517],                     # 7       5517          
