...
col = "NN_Jet_sys_TotalJECUnc_down"
...
col_up = "NN_Jet_sys_TotalJECUnc_up"
col_down = "NN_Jet_sys_TotalJECUnc_down"
...
plt.tight_layout()
fig.savefig("/t3home/gcelotto/ggHbb/documentation/plotScripts/systematics_signal/plots/JECTotal.png")
# %%
