...
#SBATCH --error=/t3home/gcelotto/slurm/output/saveFlatErr_1.out    # Output file for stderr
...
fileNumber="$6" 
flatPath="$7"
python /t3home/gcelotto/ggHbb/flatter/treeFlatter.py $nanoFileName $maxEntries $maxJet $isMC $process # to pass all the arguments
echo "Going to copy"
