...
interactive_fit = widgets.interactive(
    update_fit,
    norm=widgets.FloatSlider(value=1.13e-2, min=1e-4, max=5e-2, step=1e-4, description="norm"),
    mean=widgets.FloatSlider(value=122, min=118, max=130, step=0.5, description="mean"),
    sigma=widgets.FloatSlider(value=14, min=5, max=50, step=0.5, description="sigma"),
    alphaL=widgets.FloatSlider(value=1.03, min=1, max=10, step=0.5, description="alphaL"),
    nL=widgets.FloatSlider(value=37, min=1, max=50, step=1, description="nL"),
    alphaR=widgets.FloatSlider(value=50, min=1, max=500, step=0.5, description="alphaR"),
    nR=widgets.FloatSlider(value=6, min=1, max=50, step=1e-4, description="nR"),
    sigmaG=widgets.FloatSlider(value=15, min=1, max=100, step=0.01, description="sigmaG"),
    normG=widgets.FloatSlider(value=5e-3, min=0, max=5e-2, step=1e-4, description="normG"),
    p0=widgets.FloatSlider(value=1e-5, min=-0.01, max=0.01, step=1e-5, description="p0"),
    p1=widgets.FloatSlider(value=-1e-7, min=-1e-5, max=0, step=1e-8, description="p1"),
)
