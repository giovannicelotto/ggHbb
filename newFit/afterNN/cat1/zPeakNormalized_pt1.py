...
# %%
# Play with cuts
dfsMC = cut(dfsMC, 'dijet_pt', 100, 160)
...
ax.legend()
fig.savefig(outFolder+"/plots/zPeakFit_cat1.png", bbox_inches='tight')
fit_params = {name: {"value": m.values[name], "error": m.errors[name]} for name in m.parameters}
# %%
with open(outFolder+"/fit_parameters_Z_cat1.json", "w") as f:
...
fig2.savefig(outFolder+"/plots/zPeakFit_components_cat1.png", bbox_inches='tight')
