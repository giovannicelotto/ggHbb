...
# %%
x1, x2, key, nbins, t1, t2, t0, t3 = getBounds(paramFile="/t3home/gcelotto/ggHbb/newFit/afterNN/cat60/config_2.yaml")
plotFolder = "/t3home/gcelotto/ggHbb/newFit/afterNN/cat60/plots"
set_x_bounds(x1, x2)
...
for var in variations:
    ...
    with open("/t3home/gcelotto/ggHbb/newFit/afterNN/cat60/fit_parameters_with_systematics.json", "r") as f:
    ...
    cHiggs, cHiggs_err = plotFree(x, c, cZ, maskFit, m_tot_2, maskUnblind, bins, dfProcessesMC, dfsMC_H, MCList_H, myBkgSignalFunctions, key, myBkgFunctions, lumi_tot, myBkgParams, plotFolder, ptCut_min, ptCut_max, jet1_btagMin, jet2_btagMin, PNN_t, PNN_t_max=None,fitFunction=fitFunction, var=var)
...
outFolder="/t3home/gcelotto/ggHbb/newFit/afterNN/cat60/hists"

    
# %%
import ROOT
output_file = "/t3home/gcelotto/ggHbb/newFit/afterNN/cat60/hists/counts_cat60.root"
