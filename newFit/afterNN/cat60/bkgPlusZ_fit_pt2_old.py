...
with open("/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/config_2.yaml", "r") as f:
...
with open("/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/fit_parameters_Z_cat2p1.json", "r") as f:
...
fig.savefig("/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/plots/bkgPlusZPeak_160toInf.png", bbox_inches='tight')
# %%
...
fig.savefig("/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/plots/bkgPlusZPeak2_160toInf.png", bbox_inches='tight')
# End Plot 2
# %%
...
createRootHists([y_data_fit, y_Higgs, y_Z, y_data_blind], ['bkg', 'H', 'Z', 'data_obs'], bins=bins, outFolder="/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/hists", suffix='cat2p1')
# %%
