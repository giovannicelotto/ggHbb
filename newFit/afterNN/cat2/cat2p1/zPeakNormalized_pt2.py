...
#m.limits['fractionG2'] = (0.35, 0.95)
#m.limits['mean'] = (83, 97)
#m.limits['sigmaG'] = (4, 20)
#m.errors['sigmaG'] = 4
#m.errors["sigmaG1"] = 4
#m.errors["normSig"]=50
...
ax.legend()
fig.savefig(outFolder+"/plots/zPeak3Fit_cat2p1.png", bbox_inches='tight')
...
fig2.savefig(outFolder+"/plots/zPeak3Fit_components_cat2p1.png", bbox_inches='tight')
