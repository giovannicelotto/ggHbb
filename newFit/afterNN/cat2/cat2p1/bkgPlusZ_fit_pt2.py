...
import numpy as np
import pandas as pd
from functions import cut, getDfProcesses_v2, getCommonFilters
...
# %%
x1, x2, key, nbins, t1, t2, t0, t3 = getBounds(paramFile="/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/config_2.yaml")
plotFolder = "/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/plots"
set_x_bounds(x1, x2)
...
for var in variations:
    ...
    with open("/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/fit_parameters_with_systematics.json", "r") as f:
        fit_parameters_zPeak = json.load(f)
    fitFunction = fit_parameters_zPeak['fitFunction']
    params={
        "B" : 24.74e-3   ,
        'C' : 0.5047  ,
        'b' : -14.03e-3	,
    ...
    m_tot_2 = doFitParameterFree(x, m_tot, c, cZ, maskFit, maskUnblind, bins, dfsMC_Z, dfProcessesMC, MCList_Z, dfsMC_H, MCList_H, myBkgSignalFunctions, key, myBkgFunctions, lumi_tot, myBkgParams, plotFolder, fitFunction)
    cHiggs, cHiggs_err = plotFree(x, c, cZ, maskFit, m_tot_2, maskUnblind, bins, dfProcessesMC, dfsMC_H, MCList_H, myBkgSignalFunctions, key, myBkgFunctions, lumi_tot, myBkgParams, plotFolder, ptCut_min, None, jet1_btagMin, jet2_btagMin, PNN_t, PNN_t_max=None,fitFunction=fitFunction, var=var)
...
outFolder="/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/hists"

    
# %%
import ROOT
output_file = "/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p1/hists/counts_cat2p1.root"
