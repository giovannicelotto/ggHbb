...
fig.savefig("/t3home/gcelotto/newFit/afterNN/cat2/cat2p0/plots/bkgPlusZPeak_160toInf.png", bbox_inches='tight')
# %%
...
fig.savefig("/t3home/gcelotto/newFit/afterNN/cat2/cat2p0/plots/bkgPlusZPeak2_160toInf.png", bbox_inches='tight')
# End Plot 2
# %%
...
createRootHists([y_data_fit, y_Higgs, y_Z, y_data_blind], ['bkg', 'H', 'Z', 'data_obs'], bins=bins, outFolder="/t3home/gcelotto/newFit/afterNN/cat2/cat2p0/hists", suffix='cat2p0')
# %%
