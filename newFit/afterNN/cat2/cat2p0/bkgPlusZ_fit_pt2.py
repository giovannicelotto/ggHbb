...
import yaml
from helpers.createRootHist import createRootHists, createRootHists_Syst
from helpers.getBounds import getBounds
# %%
x1, x2, key, nbins, t1, t2, t0, t3 = getBounds(paramFile="/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p0/config_2.yaml")
plotFolder = "/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p0/plots"
set_x_bounds(x1, x2)
...
for var in variations:
    ...
    with open("/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p0/fit_parameters_with_systematics.json", "r") as f:
    ...
    cHiggs, cHiggs_err = plotFree(x, c, cZ, maskFit, m_tot_2, maskUnblind, bins, dfProcessesMC, dfsMC_H, MCList_H, myBkgSignalFunctions, key, myBkgFunctions, lumi_tot, myBkgParams, plotFolder, ptCut_min, None, jet1_btagMin, jet2_btagMin, PNN_t, PNN_t_max, fitFunction=fit_parameters_zPeak["fitFunction"],var=var)
...
outFolder="/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p0/hists"

    
# %%
import ROOT
output_file = "/t3home/gcelotto/ggHbb/newFit/afterNN/cat2/cat2p0/hists/counts_cat2p0.root"
