...
#Define variables
datacard="/t3home/gcelotto/ggHbb/newFit/afterNN/scripts/datacards/datacard_H_cat2p0.txt"
ws="/t3home/gcelotto/ggHbb/newFit/afterNN/scripts/datacards/datacard_H_cat2p0.root"
rmin=-3
rmax=5
...
plot1DScan.py $outputCombine/higgsCombinehbb_total.expected.MultiDimFit.mH125.root \
  ...
  --output plots/HiggsExp_cat2p0_StatOnly \
...
plot1DScan.py $outputCombine/higgsCombinehbb_total.expected.MultiDimFit.mH125.root \
  ...
  --others \
    ...
    $outputCombine/higgsCombinehbb_statOnly.expected.MultiDimFit.mH125.root:"Stat Only":2 \
  --output plots/HiggsExp_cat2p0_groups \
...
plotImpacts.py -i impacts_2p0.json -o impacts_cat2p0_Higgs
mv impacts_cat2p0_Higgs.pdf $plotFolder