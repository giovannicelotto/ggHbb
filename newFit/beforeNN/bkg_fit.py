...
dfsData_, lumi = loadMultiParquet_Data_new(dataTaking=[0, 1], nReals=[-1, -1,], columns=columns+['jet1_btagDeepFlavB', 'jet2_btagDeepFlavB'])
# %%
MCList = [0,36]#[1, 3, 4, 19,20,21,22]
...
ax[0].set_yscale('log')
fig.savefig("/t3home/gcelotto/newFit/plots/bkgFitSideBands_Z.png", bbox_inches='tight')
...
# %%
with open("/t3home/gcelotto/newFit/fit_parameters_bkg100_bT.json", "w") as f:
...
ax[0].set_yscale('log')
fig.savefig("/t3home/gcelotto/newFit/plots/bkgFit_components.png", bbox_inches='tight')
