...
b0_c2 = ROOT.RooRealVar("b0_c2", "b0_c2", 0.0252276, 0, 1)
b1_c2 = ROOT.RooRealVar("b1_c2", "b1_c2", 0.3892321, 0, 1)
b2_c2 = ROOT.RooRealVar("b2_c2", "b2_c2", 0.7660164, 0, 1)
...
b1_c2.setConstant(False)
b2_c2.setConstant(False)
# --- expo function ---
...
fraction_qcdParts_c2 = ROOT.RooRealVar("fraction_qcdParts_c2", "fraction_qcdParts_c2", 0.12116454804437206, 0.05, 0.15)
...
nQCD_cat2 = ROOT.RooRealVar("nQCD_cat2", "QCD yield cat2", 1230912.0232604, 0, 3e6)
...
model_cat2 =  ROOT.RooAddPdf("model_cat2", "sig+bkg", ROOT.RooArgList(qcd_total_c2, model_Z_c2), ROOT.RooArgList(nQCD_cat2, nZ_times_mu_c2))
