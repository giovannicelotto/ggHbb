...
def writeFeatures():
    ...
    columnsToRead = ['jet1_pt', 'jet1_eta', 'jet1_btagDeepFlavB',   'jet1_qgl',
                    ...
                    'muon_pt',  'nJets',     'ht', 'muon_pfRelIso03_all', 
                    'sf'    ]
    np.save("/t3home/gcelotto/ggHbb/NN/input/featuresForTraining_ptClass.npy", featuresForTraining)
    np.save("/t3home/gcelotto/ggHbb/NN/input/columnsToRead_ptClass.npy", columnsToRead)

def readFeatures():
    featuresForTraining = np.load("/t3home/gcelotto/ggHbb/NN/input/featuresForTraining_ptClass.npy")
    columnsToRead = np.load("/t3home/gcelotto/ggHbb/NN/input/columnsToRead_ptClass.npy")
...
# align consistently X and Y
        ...
        Xtrain_lowPt.to_parquet("/t3home/gcelotto/ggHbb/NN/input/Xtrain_lowPt.parquet")
        Ytrain_lowPt.to_parquet("/t3home/gcelotto/ggHbb/NN/input/Ytrain_lowPt.parquet")
        Xtrain_highPt.to_parquet("/t3home/gcelotto/ggHbb/NN/input/Xtrain_highPt.parquet")
        Ytrain_highPt.to_parquet("/t3home/gcelotto/ggHbb/NN/input/Ytrain_highPt.parquet")
        ...
        #doPlotLoss(fit=fit, outName="/t3home/gcelotto/ggHbb/NN/output/loss_lowPt.png", earlyStop=earlyStop, patience=hp['patienceES'])
        ...
        doPlotLoss(fit=fit, outName="/t3home/gcelotto/ggHbb/NN/output/loss_highPt.png", earlyStop=earlyStop, patience=hp['patienceES'])
    

    # load the train for plots
    Xtrain_lowPt      = pd.read_parquet("/t3home/gcelotto/ggHbb/NN/input/Xtrain_lowPt.parquet")
    Ytrain_lowPt      = pd.read_parquet("/t3home/gcelotto/ggHbb/NN/input/Ytrain_lowPt.parquet")['label']
    Xtrain_highPt      = pd.read_parquet("/t3home/gcelotto/ggHbb/NN/input/Xtrain_highPt.parquet")
    Ytrain_highPt      = pd.read_parquet("/t3home/gcelotto/ggHbb/NN/input/Ytrain_highPt.parquet")['label']
    # load the test
    realDataPath_test = "/pnfs/psi.ch/cms/trivcat/store/user/gcelotto/bb_ntuples/flatForGluGluHToBB/Data1A/others"
    signalPath_test = "/pnfs/psi.ch/cms/trivcat/store/user/gcelotto/bb_ntuples/nanoaod_ggH/ggH_old/ggH2023Dec06_nonUL/GluGluHToBB_M125_13TeV_powheg_pythia8/crab_GluGluHToBB/231206_105206/flatData/others"
    import glob, re, os
    ...
    #    numEventsTotalTest = numEventsTotalTest + df[(df.process=='GluGluHToBB') & (df.fileNumber==fileNumber)].numEventsTotal.iloc[0]
    numEventsTotalTest=14000000
    ...
    massSpectrum(Xtest_lowPt, Ytest_lowPt, y_predict_lowPt, SFtest_lowPt, hp, numEventsTotalTest=numEventsTotalTest, outName="/t3home/gcelotto/ggHbb/NN/output/dijetMass_afterCut_lowPt.png")
    massSpectrum(Xtest_highPt, Ytest_highPt, y_predict_highPt, SFtest_highPt, hp, numEventsTotalTest=numEventsTotalTest, outName="/t3home/gcelotto/ggHbb/NN/output/dijetMass_afterCut_highPt.png")
    
    roc(thresholds, signal_predictions_lowPt, realData_predictions_lowPt, signalTrain_predictions_lowPt, realDataTrain_predictions_lowPt, outName="/t3home/gcelotto/ggHbb/NN/output/nn_roc_lowPt.png")
    ...
    WorkingPoint(signal_predictions_lowPt[signalMask], realData_predictions_lowPt[realDataMask], SFtest_lowPt[Ytest_lowPt.label==1][signalMask],outName="/t3home/gcelotto/ggHbb/NN/output/cut_on_NN_output_lowPt.png")
    NNoutputs(signal_predictions_lowPt, realData_predictions_lowPt, signalTrain_predictions_lowPt, realDataTrain_predictions_lowPt, outName = "/t3home/gcelotto/ggHbb/NN/output/nn_outputs_lowPt.png")    
    print(type(SFtest_lowPt), type(Xtest_lowPt))
    
    assert len(SFtest_lowPt)==len(Xtest_lowPt)
    getShap(Xtest_lowPt[:300][featuresForTraining], model_lowPt, outName = "/t3home/gcelotto/ggHbb/NN/output/shap_lowPt.png")

    roc(thresholds, signal_predictions_highPt, realData_predictions_highPt, signalTrain_predictions_highPt, realDataTrain_predictions_highPt, outName="/t3home/gcelotto/ggHbb/NN/output/nn_roc_highPt.png")
    ...
    #WorkingPoint(signal_predictions_highPt[signalMask], realData_predictions_highPt[realDataMask], outName="/t3home/gcelotto/ggHbb/NN/output/cut_on_NN_output_highPt.png")
    NNoutputs(signal_predictions_highPt, realData_predictions_highPt, signalTrain_predictions_highPt, realDataTrain_predictions_highPt, outName = "/t3home/gcelotto/ggHbb/NN/output/nn_outputs_highPt.png")    
    assert len(SFtest_highPt)==len(Xtest_highPt)
    getShap(Xtest_highPt[:300][featuresForTraining], model_highPt, outName = "/t3home/gcelotto/ggHbb/NN/output/shap_highPt.png")
    return
