...
from utilsForPlot import getBins, loadData, getFeaturesBScoreBased
...
def plotNormalizedFeatures(signal, realData, outFile):
    ...
    for i in range(nRow):
        for j in range(nCol):
            ...
            countsSignal, countsSignalErr = countsSignal/N_mini*30.52*0.67*1000, countsSignalErr/N_mini*30.52*0.67*1000
            ...
            ax[i, j].set_xlabel(labels[i*nCol+j])
...
def main():
    ...
    plotNormalizedFeatures(signal=signal, realData=realData, outFile = "/t3home/gcelotto/ggHbb/outputs/plots/normalizedFeaturesNew.pdf")
