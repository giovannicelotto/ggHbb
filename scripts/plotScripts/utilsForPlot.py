...
def getBins(dictFormat=False):
    ...
    if dictFormat:
        binsDict = {
            ...
            'jet1_mass': [50.0, 0.0, 30.0], 'jet1_nMuons': [10.0, -0.5, 9.5],'jet1_nTightMuons': [10.0, -0.5, 9.5], 'jet1_nElectrons': [6.0, -0.5, 5.5],
            ...
            'jet2_mass': [50.0, 0, 20], 'jet2_nMuons': [10.0, -0.5, 9.5], 'jet2_nTightMuons': [10.0, -0.5, 9.5],'jet2_nElectrons': [5.0, -0.5, 4.5],
            ...
            'muon_tightId': [2.0, -0.5, 1.5], 'muon_pfRelIso03_all': [10.0, 0, 4], 'muon_tkIsoId': [3.0, -0.5, 2.5], 
            'Muon_vx': [20, -0.50, .50],
            'Muon_vy': [20, -0.50, .50],
            'sf': [50.0, 0.0, 1.0]}
