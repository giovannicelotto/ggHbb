...
def plotDijetMass(afterCut= True, log = True, fit = True):
    ...
    currentLumi = 0.67*20/1017
    N_SignalMini = np.load("/t3home/gcelotto/ggHbb/outputs/N_mini.npy")
    ...
    if log:
        outName = outFolder+"/dijetMassCut_log.png" if afterCut else outFolder+"/dijetMass_log.png"
    else:
        outName = outFolder+"/dijetMassCut.png" if afterCut else outFolder+"/dijetMass.png"
