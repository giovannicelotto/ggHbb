...
def predict(file_path, modelName, boosted, run=2):
    '''
    ...
    return data_predictions1, data_predictions_pca_varied, data_predictions_qm
...
if __name__ == "__main__":
    ...
    predictions1, data_predictions_pca_varied, data_predictions_qm = predict(file_path, modelName, boosted)
