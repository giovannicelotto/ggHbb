...
xrdcp -f -N "$source_dir/yMjj_"$process"_FN"$number".parquet" "root://t3dcachedb.psi.ch:1094///pnfs/psi.ch/cms/trivcat/store/user/gcelotto/mjjDiscoPred_"$modelName"/"$process"/others/yMjj_${process}_FN${number}.parquet"
xrdfs root://t3dcachedb.psi.ch stat /pnfs/psi.ch/cms/trivcat/store/user/gcelotto/mjjDiscoPred_$modelName/$process/others/yMjj_${process}_FN${number}.parquet
