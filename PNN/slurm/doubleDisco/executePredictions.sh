...
python /t3home/gcelotto/ggHbb/PNN/slurm/doubleDisco/runPredictions.py -MC 0 -pN 3 -n -1 -m $modelName -gpu 1 -e $epoch
...
python /t3home/gcelotto/ggHbb/PNN/slurm/doubleDisco/runPredictions.py -MC 0 -pN 6 -n -1 -m $modelName -gpu 1 -e $epoch
