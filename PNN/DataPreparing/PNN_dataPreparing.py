...
Xtrain['jet3_btagWP'] = np.where(Xtrain.jet3_pt == 0, -1, 0)
Xtrain['jet3_btagWP'] = np.where(Xtrain.jet3_btagDeepFlavB > 0.049, 1, Xtrain['jet3_btagWP'])
Xtrain['jet3_btagWP'] = np.where(Xtrain.jet3_btagDeepFlavB > 0.2783, 2, Xtrain['jet3_btagWP'])
Xtrain['jet3_btagWP'] = np.where(Xtrain.jet3_btagDeepFlavB > 0.71, 3,Xtrain['jet3_btagWP'])

Xval['jet3_btagWP'] = np.where(Xval.jet3_pt == 0, -1, 0)
Xval['jet3_btagWP'] = np.where(Xval.jet3_btagDeepFlavB > 0.049, 1, Xval['jet3_btagWP'])
Xval['jet3_btagWP'] = np.where(Xval.jet3_btagDeepFlavB > 0.2783, 2, Xval['jet3_btagWP'])
Xval['jet3_btagWP'] = np.where(Xval.jet3_btagDeepFlavB > 0.71, 3,Xval['jet3_btagWP'])
