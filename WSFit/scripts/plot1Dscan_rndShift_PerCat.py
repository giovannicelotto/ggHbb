...
for pdfIdx in range(nPDFs):
    ...
    ax.plot(r_pdf_i[pdfIdx][1:],y_pdf_i[1:], 'o', markersize=5, label=pdfLabels[idx][pdfIdx], linestyle='-', linewidth=1)
...
if os.path.exists("/t3home/gcelotto/ggHbb/WSFit/output/cat%d/plots/multipdf_results/")==False:
