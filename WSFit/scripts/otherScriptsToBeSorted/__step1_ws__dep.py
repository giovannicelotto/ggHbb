# Take the dataframes saved with NN score
# Open config files to apply cuts
# Define the signal modelling
...
print("[INFO] Number of Z expected in category %s is %.2f"%(args.config, nZ_cat.getVal()))
print("*"*30)
print("\n"*15)
