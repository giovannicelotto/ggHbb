...
combine -M FitDiagnostics -d "datacardMulti"$CATEGORY".txt" -t -1 --expectSignal 1  --X-rtd MINIMIZER_freezeDisassociatedParams --setParameterRange r=-30,30:rateZbb=-3,5 --freezeParameters "pdfindex_"$CATEGORY"_2016_13TeV" --cminDefaultMinimizerStrategy 0  --setParameters "pdfindex_"$CATEGORY"_2016_13TeV"=0
#
#
## Print impacts
...
combineTool.py -M Impacts -d "datacardMulti"$CATEGORY".root" -m 125 -n .impacts --setParameterRanges r=-30,30 --doFits --robustFit 1  --X-rtd MINIMIZER_freezeDisassociatedParams -t -1 --expectSignal 1 \
                        --freezeParameters "pdfindex_"$CATEGORY"_2016_13TeV" --cminDefaultMinimizerStrategy 0 
combineTool.py -M Impacts -d "datacardMulti"$CATEGORY".root" -m 125 -n .impacts --setParameterRanges r=-30,30 -o "impacts_datacardMulti"$CATEGORY".json"
plotImpacts.py -i "impacts_datacardMulti"$CATEGORY".json" -o "impacts_datacardMulti"$CATEGORY